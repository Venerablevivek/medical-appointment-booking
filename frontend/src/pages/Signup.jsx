        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 ' >
          ...
          <div className='hidden lg:block bg-primaryColor rounded-l-lg ' >
              <figure className='rounded-l-lg' >
                <img src={signupImg} alt='Signup Image' loading='lazy' className='w-full rounded-l-lg ' />
              </figure>
          </div>
          ...
          <div className='rounded-l-lg lg:pl-16 py-10 ' >
            ...
            <form onSubmit={submitHandler} >
                <div className='mb-5' >
                      {/* <label for='email' className='text__para font-bold ml-4 ' >Email</label> */}
              ...
              <div className='mb-5 flex items-center gap-3 ' >
                {
                  ...
                  <img src={previewURL} alt='Doctor image' loading='lazy' className='w-full h-full rounded-full ' />
                </figure>
                }
              ...
              <p className='mt-5 text-textColor text-center ' >
                Already have an account? <Link to='/login' className='font-medium text-primaryColor ml-1 ' >Login</Link>
              </p>
