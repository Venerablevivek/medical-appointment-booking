...
const DoctorCard = ({doctor}) => {
    ...
    const {name, averageRating, totalRating, photo, specialization, experiences, hospital} = doctor;
  ...
  return (
    <div className='p-3 lg:p-5 ' >
        <div>
            <img src={photo} className='w-full' alt='Doctor Image' loading='lazy' />
        </div>
        ...
        <div className='mt-2 lg:mt-4 flex items-center justify-between ' >
            ...
            <div className='flex items-center gap-[6px] ' >
                ...
                font-semibold text-headingColor ' >
                    <img src={starIcon} alt='Icon' loading='lazy' /> {rates}
                </span>
