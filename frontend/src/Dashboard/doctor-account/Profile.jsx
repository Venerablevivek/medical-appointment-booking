...
const Profile = ({doctorData}) => {
  ...
  console.log("doctorr at profile is ", doctorData);
  const updateProfileHandler = async (e) =>{
    e.preventDefault();

    try {

      const res = await fetch(`${BASE_URL}/doctors/update/${doctorData._id}`,{
        method:'PUT',
        headers:{
    ...
    <div>
        ...
        <form>
            ...
            <div className='mb-5 flex items-center gap-3 ' >
            {
                  ...
                  <img src={formData.photo} alt='Doctor image' loading='lazy' className='w-full h-full rounded-full ' />
                </figure>
                }
